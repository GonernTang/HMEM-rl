...
class AdvantageEstimator(str, Enum):
    ...
    SESSION_GRPO = "session_grpo"
    SESSION_GRPO_PASSK = "session_grpo_passk"
...
@register_adv_est(AdvantageEstimator.SESSION_GRPO)
def compute_session_grpo_advantage(
    ...
    Args:
        ...
        is_evidence_session: array of bool, True for evidence sessions
...
@register_adv_est(AdvantageEstimator.SESSION_GRPO_PASSK)
